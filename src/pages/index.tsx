  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless HR management with Example app. Empowering companies to efficiently manage employee data, payroll, and attendance."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless HR management with Example app. Empowering companies to efficiently manage employee data, payroll, and attendance.`}
            </Text>
            <Box
